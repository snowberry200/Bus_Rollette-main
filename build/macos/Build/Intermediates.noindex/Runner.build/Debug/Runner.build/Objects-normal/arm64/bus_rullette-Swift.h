...
#ifndef BUS_RULLETTE_SWIFT_H
#define BUS_RULLETTE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="bus_rullette",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12bus_rullette11AppDelegate")
...
SWIFT_CLASS("_TtC12bus_rullette17MainFlutterWindow")
